...
export function ContentProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      if (storedLogo) {
        ...
        setLogoUrl("https://www.image2url.com/r2/default/images/1780210596854-d50e17fe-f288-45b0-8d70-5a0cb736b9be.jpeg");
      }
      ...
      console.warn("Failed to read customizable content from storage: ", e);
    }
  }, []);
  ...
  const updateWebsites = (newWebsites: WebsiteProduct[]) => {
    ...
    // Also sync the preselection list in checkout dropdown modal
    try {
