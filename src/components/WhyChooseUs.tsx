...
export default function WhyChooseUs() {
  ...
  const timelineItems = [
    ...
    },
    {
      id: "item-3",
      step: 3,
      title: "স্মার্ট পেমেন্ট গেটওয়ে ও অটোমেটেড নোটিফিকেশন",
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-5">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/25 text-purple-400 text-xs font-semibold uppercase tracking-wider"
          >
            <HelpCircle className="w-4 h-4" />
            <span>হোয়াই এভেক্সন</span>
          </motion.div>
            ...
            {timelineItems.map((item, idx) => (
              ...
              >
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0, x: item.align === "left" ? -60 : 60, scale: 0.93 }}
