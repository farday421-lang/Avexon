...
export default function CheckoutModal({ isOpen, onClose, preselectedWebsiteTitle, checkoutType: initialCheckoutType, initialMode }: CheckoutModalProps) {
  ...
  const [price, setPrice] = useState<number>(() => {
    ...
    if (offerConfig?.discountActive && offerConfig?.discountPercentage) {
  ...
  }, [selectedWebsite, websites, checkoutType, offerConfig]);
  ...
  }, [checkoutType, websites, selectedWebsite, isOpen, offerConfig]);
    ...
    return (
      <div className="space-y-5 font-sans tracking-tight py-2">
        ...
        <div className="text-center space-y-1 relative z-10">
          ...
          <div className="mt-2 py-2.5 px-3.5 rounded-xl bg-purple-950/15 border border-purple-500/10 text-left flex flex-wrap items-center justify-between gap-3 text-xs">
